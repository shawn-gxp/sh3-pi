...
CLI entry — interactive menu or argparse subcommands.
  ...
  python -m medical_ble_toolkit.omron_bp              → interactive menu
  python -m medical_ble_toolkit.omron_bp pair ...
  python -m medical_ble_toolkit.omron_bp read ...     → wait for cuff, download once
  python -m medical_ble_toolkit.omron_bp watch ...    → auto-fetch: wait longer, download, show latest
...
from medical_ble_toolkit.omron_bp import __app_name__, __version__
from medical_ble_toolkit.omron_bp.ble.scanner import pick_device_interactive
from medical_ble_toolkit.omron_bp.config.store import load_device_config, save_device_config
...
from medical_ble_toolkit.omron_bp.logging_config import DBG_TAG, get_logger, setup_logging
