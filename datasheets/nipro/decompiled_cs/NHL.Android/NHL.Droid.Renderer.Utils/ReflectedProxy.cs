...
public class ReflectedProxy<T> where T : class
{
	...
	public object Call([CallerMemberName] string methodName = "", object[] parameters = null)
	{
		...
		{
			_cachedMethodInfo[methodName] = _targetMethodInfoList.Single((MethodInfo mi) => mi.Name == methodName || mi.Name.Contains("." + methodName));
		}
	...
	private PropertyInfo GetPropertyInfo(string propertyName)
	{
		...
		{
			_cachedPropertyInfo[propertyName] = _targetPropertyInfoList.Single((PropertyInfo pi) => pi.Name == propertyName || pi.Name.Contains("." + propertyName));
		}
