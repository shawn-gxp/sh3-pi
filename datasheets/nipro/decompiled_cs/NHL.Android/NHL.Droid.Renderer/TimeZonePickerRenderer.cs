...
public class TimeZonePickerRenderer : PickerRenderer
{
	...
	{
		TimeZonePicker model = base.Element as TimeZonePicker;
		...
		builder.SetPositiveButton("OK", delegate
		{
			...
			{
				int num = ((picker.Value != 48) ? picker2.Value : 0);
