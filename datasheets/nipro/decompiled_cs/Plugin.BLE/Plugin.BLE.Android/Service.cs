...
public class Service : ServiceBase
{
	...
	{
		return Task.FromResult((IList<ICharacteristic>)_nativeService.Characteristics.Select((BluetoothGattCharacteristic characteristic) => new Characteristic(characteristic, _gatt, _gattCallback, this)).Cast<ICharacteristic>().ToList());
	}
}
