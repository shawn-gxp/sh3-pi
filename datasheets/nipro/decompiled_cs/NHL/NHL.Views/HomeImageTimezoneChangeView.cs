...
[XamlFilePath("Views/HomeImageTimezoneChangeView.xaml")]
public class HomeImageTimezoneChangeView : ContentPage
{
	public HomeImageTimezoneChangeView()
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		{
			AssemblyName = typeof(HomeImageTimezoneChangeView).GetTypeInfo().Assembly.GetName(),
			ResourcePath = "Views/HomeImageTimezoneChangeView.xaml",
			Instance = this
		}))
		{
		...
		Grid grid3 = new Grid();
		HomeImageTimezoneChangeView homeImageTimezoneChangeView;
		NameScope nameScope = (NameScope)(NameScope.GetNameScope(homeImageTimezoneChangeView = this) ?? new NameScope());
		NameScope.SetNameScope(homeImageTimezoneChangeView, nameScope);
		homeImageTimezoneChangeView.Resources = resourceDictionary;
		VisualDiagnostics.RegisterSourceInfo(resourceDictionary, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 12, 10);
		resourceDictionary.Add("Base64ToImageSourceConverter", value);
		resourceDictionary.Add("TimezoneLabel", color);
		homeImageTimezoneChangeView.SetValue(NavigationPage.HasBackButtonProperty, true);
		homeImageTimezoneChangeView.SetValue(NavigationPage.BackButtonTitleProperty, "戻る");
		homeImageTimezoneChangeView.Resources = resourceDictionary;
		VisualDiagnostics.RegisterSourceInfo(resourceDictionary, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 12, 10);
		onPlatform.iOS = new Thickness(0.0, 30.0, 0.0, 0.0);
		onPlatform.Android = new Thickness(0.0, 10.0, 0.0, 0.0);
		homeImageTimezoneChangeView.SetValue(Page.PaddingProperty, (Thickness)onPlatform);
		VisualDiagnostics.RegisterSourceInfo(onPlatform, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 24, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(grid, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 38, 10);
		...
		array[1] = image;
		array[2] = grid3;
		array[3] = homeImageTimezoneChangeView;
		object service;
		...
		xamlServiceProvider.Add(typeFromHandle2, new XamlTypeResolver(xmlNamespaceResolver, typeof(HomeImageTimezoneChangeView).GetTypeInfo().Assembly));
		...
		VisualDiagnostics.RegisterSourceInfo(target, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 39, 29);
		...
		VisualDiagnostics.RegisterSourceInfo(image, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 39, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(fixedFontSizeTextBoxEffect, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 49, 22);
		grid2.Children.Add(datePicker);
		VisualDiagnostics.RegisterSourceInfo(datePicker, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 47, 14);
		...
		VisualDiagnostics.RegisterSourceInfo(fixedFontSizeTextBoxEffect2, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 54, 22);
		grid2.Children.Add(timePicker);
		VisualDiagnostics.RegisterSourceInfo(timePicker, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 52, 14);
		grid3.Children.Add(grid2);
		VisualDiagnostics.RegisterSourceInfo(grid2, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 41, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(image2, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 59, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(fixedFontSizeButtonEffect, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 62, 18);
		grid3.Children.Add(button);
		VisualDiagnostics.RegisterSourceInfo(button, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 60, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(image3, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 65, 10);
		...
		VisualDiagnostics.RegisterSourceInfo(fixedFontSizeButtonEffect2, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 68, 18);
		grid3.Children.Add(button2);
		VisualDiagnostics.RegisterSourceInfo(button2, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 66, 10);
		homeImageTimezoneChangeView.SetValue(ContentPage.ContentProperty, grid3);
		VisualDiagnostics.RegisterSourceInfo(grid3, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 29, 6);
		VisualDiagnostics.RegisterSourceInfo(homeImageTimezoneChangeView, new Uri("Views/HomeImageTimezoneChangeView.xaml", UriKind.RelativeOrAbsolute), 2, 2);
	}

	private void __InitComponentRuntime()
	{
		this.LoadFromXaml(typeof(HomeImageTimezoneChangeView));
	}
}
