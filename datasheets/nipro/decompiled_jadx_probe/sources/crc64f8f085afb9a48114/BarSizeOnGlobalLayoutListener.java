...
public class BarSizeOnGlobalLayoutListener implements IGCUserPeer, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    static {
        Runtime.register("BottomNavigationBar.Listeners.BarSizeOnGlobalLayoutListener, BottomNavigationBar", BarSizeOnGlobalLayoutListener.class, "n_onGlobalLayout:()V:GetOnGlobalLayoutHandler:Android.Views.ViewTreeObserver/IOnGlobalLayoutListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public BarSizeOnGlobalLayoutListener() {
        if (BarSizeOnGlobalLayoutListener.class == BarSizeOnGlobalLayoutListener.class) {
            TypeManager.Activate("BottomNavigationBar.Listeners.BarSizeOnGlobalLayoutListener, BottomNavigationBar", "", this, new Object[0]);
        }
    }
