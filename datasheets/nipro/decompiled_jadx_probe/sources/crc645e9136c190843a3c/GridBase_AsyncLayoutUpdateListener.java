...
public class GridBase_AsyncLayoutUpdateListener implements IGCUserPeer, View.OnLayoutChangeListener {
    ...
    static {
        Runtime.register("C1.Android.Grid.GridBase+AsyncLayoutUpdateListener, C1.Android.Grid", GridBase_AsyncLayoutUpdateListener.class, "n_onLayoutChange:(Landroid/view/View;IIIIIIII)V:GetOnLayoutChange_Landroid_view_View_IIIIIIIIHandler:Android.Views.View/IOnLayoutChangeListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public GridBase_AsyncLayoutUpdateListener() {
        if (GridBase_AsyncLayoutUpdateListener.class == GridBase_AsyncLayoutUpdateListener.class) {
            TypeManager.Activate("C1.Android.Grid.GridBase+AsyncLayoutUpdateListener, C1.Android.Grid", "", this, new Object[0]);
        }
    }
