...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawDebug(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleStroke));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(SupportMenu.CATEGORY_MASK, jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleStroke));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleStroke));
