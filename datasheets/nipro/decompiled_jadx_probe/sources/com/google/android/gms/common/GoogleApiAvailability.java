...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    final Dialog zaf(@NonNull Context context, int i, zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        if (i == 0) {
            return null;
        }
    ...
    final void zag(Activity activity, Dialog dialog, String str, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        try {
