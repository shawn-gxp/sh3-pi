...
public class SwipeTouchListener implements IGCUserPeer, View.OnTouchListener {
    ...
    static {
        Runtime.register("C1.Android.Core.SwipeTouchListener, C1.Android.Core", SwipeTouchListener.class, "n_onTouch:(Landroid/view/View;Landroid/view/MotionEvent;)Z:GetOnTouch_Landroid_view_View_Landroid_view_MotionEvent_Handler:Android.Views.View/IOnTouchListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public SwipeTouchListener() {
        if (SwipeTouchListener.class == SwipeTouchListener.class) {
            TypeManager.Activate("C1.Android.Core.SwipeTouchListener, C1.Android.Core", "", this, new Object[0]);
        }
    }
