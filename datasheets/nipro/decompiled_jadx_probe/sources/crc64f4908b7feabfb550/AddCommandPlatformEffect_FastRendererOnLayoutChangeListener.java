...
public class AddCommandPlatformEffect_FastRendererOnLayoutChangeListener implements IGCUserPeer, View.OnLayoutChangeListener {
    ...
    static {
        Runtime.register("AiForms.Effects.Droid.AddCommandPlatformEffect+FastRendererOnLayoutChangeListener, AiForms.Effects.Droid", AddCommandPlatformEffect_FastRendererOnLayoutChangeListener.class, "n_onLayoutChange:(Landroid/view/View;IIIIIIII)V:GetOnLayoutChange_Landroid_view_View_IIIIIIIIHandler:Android.Views.View/IOnLayoutChangeListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public AddCommandPlatformEffect_FastRendererOnLayoutChangeListener() {
        if (AddCommandPlatformEffect_FastRendererOnLayoutChangeListener.class == AddCommandPlatformEffect_FastRendererOnLayoutChangeListener.class) {
            TypeManager.Activate("AiForms.Effects.Droid.AddCommandPlatformEffect+FastRendererOnLayoutChangeListener, AiForms.Effects.Droid", "", this, new Object[0]);
        }
    }
