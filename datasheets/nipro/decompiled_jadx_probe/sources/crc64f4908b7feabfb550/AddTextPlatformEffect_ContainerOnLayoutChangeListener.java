...
public class AddTextPlatformEffect_ContainerOnLayoutChangeListener implements IGCUserPeer, View.OnLayoutChangeListener {
    ...
    static {
        Runtime.register("AiForms.Effects.Droid.AddTextPlatformEffect+ContainerOnLayoutChangeListener, AiForms.Effects.Droid", AddTextPlatformEffect_ContainerOnLayoutChangeListener.class, "n_onLayoutChange:(Landroid/view/View;IIIIIIII)V:GetOnLayoutChange_Landroid_view_View_IIIIIIIIHandler:Android.Views.View/IOnLayoutChangeListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public AddTextPlatformEffect_ContainerOnLayoutChangeListener() {
        if (AddTextPlatformEffect_ContainerOnLayoutChangeListener.class == AddTextPlatformEffect_ContainerOnLayoutChangeListener.class) {
            TypeManager.Activate("AiForms.Effects.Droid.AddTextPlatformEffect+ContainerOnLayoutChangeListener, AiForms.Effects.Droid", "", this, new Object[0]);
        }
    }
