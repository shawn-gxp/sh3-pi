...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    private static class FileSaveTask extends AsyncTask<String, Void, Void> {
        ...
        private void saveFileBlocking(File img) {
            ...
            try {
                FileOutputStream fileOutputStream2 = new FileOutputStream(img);
    ...
    @NonNull
    public static ListenableFuture<Bitmap> loadBitmap(@NonNull final ContentResolver resolver, @NonNull final Uri uri) {
