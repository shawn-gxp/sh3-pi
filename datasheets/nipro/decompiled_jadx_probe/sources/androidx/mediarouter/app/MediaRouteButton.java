...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context2, androidx.mediarouter.R.styleable.MediaRouteButton, attributeSet, obtainStyledAttributes, i, 0);
        if (isInEditMode()) {
            this.mRouter = null;
            this.mCallback = null;
            this.mRemoteIndicator = getResources().getDrawable(obtainStyledAttributes.getResourceId(androidx.mediarouter.R.styleable.MediaRouteButton_externalRouteEnabledDrawableStatic, 0));
            return;
        }
        ...
        this.mButtonTint = obtainStyledAttributes.getColorStateList(androidx.mediarouter.R.styleable.MediaRouteButton_mediaRouteButtonTint);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(androidx.mediarouter.R.styleable.MediaRouteButton_android_minWidth, 0);
        this.mMinHeight = obtainStyledAttributes.getDimensionPixelSize(androidx.mediarouter.R.styleable.MediaRouteButton_android_minHeight, 0);
        ...
        this.mRemoteIndicatorResIdToLoad = obtainStyledAttributes.getResourceId(androidx.mediarouter.R.styleable.MediaRouteButton_externalRouteEnabledDrawable, 0);
    ...
    private boolean showOutputSwitcher() {
        ...
        while (it.hasNext()) {
            ...
            if (activityInfo != null && (applicationInfo = activityInfo.applicationInfo) != null && (applicationInfo.flags & jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypeface) != 0) {
