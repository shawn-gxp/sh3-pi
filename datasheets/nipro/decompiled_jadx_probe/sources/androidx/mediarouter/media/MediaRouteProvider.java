...
public abstract class MediaRouteProvider {
    ...
    final void setDiscoveryRequestInternal(@Nullable MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest) {
    ...
    public static abstract class DynamicGroupRouteController extends RouteController {
        ...
        void setOnDynamicRoutesChangedListener(@NonNull Executor executor, @NonNull final OnDynamicRoutesChangedListener onDynamicRoutesChangedListener) {
        ...
        public final void notifyDynamicRoutesChanged(final Collection<DynamicRouteDescriptor> collection) {
            synchronized (this.mLock) {
                if (this.mExecutor != null) {
                    ...
                    this.mExecutor.execute(new Runnable() { // from class: androidx.mediarouter.media.MediaRouteProvider.DynamicGroupRouteController.2
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public final void notifyDynamicRoutesChanged(@NonNull final MediaRouteDescriptor mediaRouteDescriptor, @NonNull final Collection<DynamicRouteDescriptor> collection) {
            ...
            synchronized (this.mLock) {
                if (this.mExecutor != null) {
                    final OnDynamicRoutesChangedListener onDynamicRoutesChangedListener = this.mListener;
                    this.mExecutor.execute(new Runnable() { // from class: androidx.mediarouter.media.MediaRouteProvider.DynamicGroupRouteController.3
                        @Override // java.lang.Runnable
                        public void run() {
                            onDynamicRoutesChangedListener.onRoutesChanged(DynamicGroupRouteController.this, mediaRouteDescriptor, collection);
                        }
