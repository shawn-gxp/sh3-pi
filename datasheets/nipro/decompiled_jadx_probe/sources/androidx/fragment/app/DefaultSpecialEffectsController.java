...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    @NonNull
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(@NonNull List<TransitionInfo> list, final boolean z, @Nullable final SpecialEffectsController.Operation operation, @Nullable final SpecialEffectsController.Operation operation2) {
        View view;
            ...
            if (!transitionInfo3.hasSharedElementTransition() || operation6 == null || operation7 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    if (arrayList4.isEmpty()) {
                        ...
                        View view10 = arrayMap3.get(arrayList4.get(0));
