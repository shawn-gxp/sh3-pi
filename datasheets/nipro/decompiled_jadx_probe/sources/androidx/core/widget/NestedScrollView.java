...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        int i = jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (!keyEvent.isAltPressed()) {
                return arrowScroll(jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle);
            }
            return fullScroll(jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = jp.niprogenkinote.R.styleable.FlexChart_FlexChart_plotStyleTypefaceStyle;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
