...
public abstract class WidgetRun implements Dependency {
    ...
    private void resolveDimension(int i, int i2) {
        ...
        if (i4 == 2) {
            ...
            if (parent != null) {
                if ((i == 0 ? parent.horizontalRun : parent.verticalRun).dimension.resolved) {
                    ConstraintWidget constraintWidget = this.widget;
                    this.dimension.resolve(getLimitedDimension((int) ((r8.dimension.value * (i == 0 ? constraintWidget.mMatchConstraintPercentWidth : constraintWidget.mMatchConstraintPercentHeight)) + 0.5f), i));
                    return;
                }
                return;
            }
        ...
        if ((i == 0 ? constraintWidget3.verticalRun : constraintWidget3.horizontalRun).dimension.resolved) {
            float dimensionRatio = this.widget.getDimensionRatio();
            if (i == 1) {
                i3 = (int) ((r8.dimension.value / dimensionRatio) + 0.5f);
            } else {
                i3 = (int) ((dimensionRatio * r8.dimension.value) + 0.5f);
            }
