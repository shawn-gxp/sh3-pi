...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        public void measure(int i, int i2) {
            ...
            if (i5 == Integer.MIN_VALUE || i5 == 0) {
                ...
                i3 = (int) (motionLayout6.mStartWrapWidth + (motionLayout6.mPostInterpolationPosition * (motionLayout6.mEndWrapWidth - r1)));
            }
            int i6 = i3;
            int i7 = MotionLayout.this.mHeightMeasureMode;
            if (i7 == Integer.MIN_VALUE || i7 == 0) {
                MotionLayout motionLayout7 = MotionLayout.this;
                i4 = (int) (motionLayout7.mStartWrapHeight + (motionLayout7.mPostInterpolationPosition * (motionLayout7.mEndWrapHeight - r1)));
            }
    ...
    private void evaluateLayout() {
        ...
        long nanoTime = getNanoTime();
        float f = this.mTransitionLastPosition + (!(this.mInterpolator instanceof StopLogic) ? (((nanoTime - this.mTransitionLastTime) * signum) * 1.0E-9f) / this.mTransitionDuration : 0.0f);
