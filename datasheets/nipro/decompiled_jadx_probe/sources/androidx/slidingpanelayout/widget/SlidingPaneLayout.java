        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (i13 == -2) {
                    ...
                    i7 = Integer.MIN_VALUE;
                    if (i13 == -1) {
                        makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i12, BasicMeasure.EXACTLY);
                    } else {
                        makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(i13, BasicMeasure.EXACTLY);
                        i8 = ((ViewGroup.MarginLayoutParams) layoutParams).height;
                        if (i8 != -2) {
                            i9 = View.MeasureSpec.makeMeasureSpec(paddingTop, i7);
                        } else {
                            if (i8 == -1) {
                                makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(paddingTop, BasicMeasure.EXACTLY);
                            } else {
                                makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i8, BasicMeasure.EXACTLY);
                            }
                            i9 = makeMeasureSpec5;
                        }
                        ...
                        if (!z3 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z3) {
                                    ...
                                    i5 = i14;
                                    int makeMeasureSpec6 = View.MeasureSpec.makeMeasureSpec(i17, BasicMeasure.EXACTLY);
                                    ...
                                    i5 = i14;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth3 + ((int) ((layoutParams2.weight * Math.max(0, i11)) / f2)), BasicMeasure.EXACTLY), makeMeasureSpec);
                                    i15++;
                                    i14 = i5;
                                    i4 = 8;
                                }
                            }
                        } else if (((ViewGroup.MarginLayoutParams) layoutParams2).width < 0 && (measuredWidth3 > i14 || layoutParams2.weight > 0.0f)) {
                            if (z4) {
                                ...
                                if (i18 == -2) {
                                    ...
                                    i6 = BasicMeasure.EXACTLY;
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i18, BasicMeasure.EXACTLY);
                                }
                            } else {
                                i6 = BasicMeasure.EXACTLY;
            ...
            if ((isLayoutRtlSupport ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) <= 0) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt != this.mSlideableView) {
                        ...
                        int i3 = ((int) (f3 * i2)) - ((int) ((1.0f - f) * i2));
                        if (isLayoutRtlSupport) {
                            i3 = -i3;
                        }
