                ...
                if (!shouldLayout || shouldLayout2) {
                    ...
                    if (!z2) {
                        ...
                        if (shouldLayout2) {
                            ...
                            int i31 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams6).topMargin;
                        ...
                        if (shouldLayout2) {
                            ...
                            int i34 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams8).topMargin;
                            ...
                            int i35 = ((ViewGroup.MarginLayoutParams) layoutParams8).bottomMargin;
                        } else {
                            i17 = max;
                        }
                        if (z3) {
