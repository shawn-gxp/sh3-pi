                ...
                if (z4 || (i43 != 0 && f > 0.0f)) {
                    ...
                    while (i46 < i3) {
                        ...
                        if (virtualChildAt3.getVisibility() == 8) {
                            ...
                            int i48 = ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin;
                            ...
                            if (mode != 1073741824) {
                                ...
                                if (((ViewGroup.MarginLayoutParams) layoutParams3).width == -1) {
                                    ...
                                    boolean z7 = !z6 && ((ViewGroup.MarginLayoutParams) layoutParams3).width == i9;
                                    int i49 = this.mTotalLength;
                                    this.mTotalLength = Math.max(i49, virtualChildAt3.getMeasuredHeight() + i49 + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin + getNextLocationOffset(virtualChildAt3));
                                    z6 = z7;
                                    i4 = i8;
                                    i45 = max4;
                                    f = f7;
                            ...
                            this.mTotalLength = Math.max(i492, virtualChildAt3.getMeasuredHeight() + i492 + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin + getNextLocationOffset(virtualChildAt3));
                            z6 = z7;
                            i4 = i8;
                            i45 = max42;
                            f = f7;
            ...
            while (i37 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    if (z7) {
                        ...
                        i12 = max;
                        this.mTotalLength = Math.max(i38, i38 + i19 + ((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin + getNextLocationOffset(virtualChildAt2));
                        i37++;
                        max = i12;
                    }
                }
        ...
        if (z8 || (i40 != 0 && f2 > 0.0f)) {
            ...
            while (i44 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (((ViewGroup.MarginLayoutParams) layoutParams3).width == 0) {
                            ...
                            if (mode == 1073741824) {
                                ...
                                virtualChildAt3.measure(View.MeasureSpec.makeMeasureSpec(i45, BasicMeasure.EXACTLY), childMeasureSpec);
                                i43 = View.combineMeasuredStates(i43, virtualChildAt3.getMeasuredState() & ViewCompat.MEASURED_STATE_MASK);
                                f2 = f7;
                                i7 = i46;
                            }
                        } else {
                    ...
                    if (z7) {
                        ...
                        f = f2;
                        this.mTotalLength = Math.max(i47, virtualChildAt3.getMeasuredWidth() + i47 + ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
            ...
            if (z11 && mode != 1073741824) {
                for (int i50 = 0; i50 < virtualChildCount; i50++) {
                    View virtualChildAt4 = getVirtualChildAt(i50);
                    if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((LayoutParams) virtualChildAt4.getLayoutParams()).weight > 0.0f) {
                        virtualChildAt4.measure(View.MeasureSpec.makeMeasureSpec(i19, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredHeight(), BasicMeasure.EXACTLY));
                    }
                }
            }
            i4 = i2;
