...
public class EditorRenderer extends EditorRendererBase_1 implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.EditorRenderer, Xamarin.Forms.Platform.Android", EditorRenderer.class, "");
    }

    public EditorRenderer(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        if (EditorRenderer.class == EditorRenderer.class) {
