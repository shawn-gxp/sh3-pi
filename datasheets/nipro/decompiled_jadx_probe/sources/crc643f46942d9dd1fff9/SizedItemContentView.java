...
public class SizedItemContentView extends ItemContentView implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.SizedItemContentView, Xamarin.Forms.Platform.Android", SizedItemContentView.class, "n_onMeasure:(II)V:GetOnMeasure_IIHandler\n");
    }

    public SizedItemContentView(Context context) {
        super(context);
        if (SizedItemContentView.class == SizedItemContentView.class) {
