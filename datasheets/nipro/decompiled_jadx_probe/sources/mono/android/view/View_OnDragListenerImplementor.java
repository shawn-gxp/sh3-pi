...
public class View_OnDragListenerImplementor implements IGCUserPeer, View.OnDragListener {
    ...
    static {
        Runtime.register("Android.Views.View+IOnDragListenerImplementor, Mono.Android", View_OnDragListenerImplementor.class, __md_methods);
    }

    public View_OnDragListenerImplementor() {
        if (View_OnDragListenerImplementor.class == View_OnDragListenerImplementor.class) {
