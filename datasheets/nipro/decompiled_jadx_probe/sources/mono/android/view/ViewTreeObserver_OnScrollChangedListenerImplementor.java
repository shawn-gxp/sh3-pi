...
public class ViewTreeObserver_OnScrollChangedListenerImplementor implements IGCUserPeer, ViewTreeObserver.OnScrollChangedListener {
    ...
    static {
        Runtime.register("Android.Views.ViewTreeObserver+IOnScrollChangedListenerImplementor, Mono.Android", ViewTreeObserver_OnScrollChangedListenerImplementor.class, "n_onScrollChanged:()V:GetOnScrollChangedHandler:Android.Views.ViewTreeObserver/IOnScrollChangedListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public ViewTreeObserver_OnScrollChangedListenerImplementor() {
        if (ViewTreeObserver_OnScrollChangedListenerImplementor.class == ViewTreeObserver_OnScrollChangedListenerImplementor.class) {
