...
public final class DelayKt {
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1373scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1329delayp9JZ4hM(double d, Continuation<? super Unit> continuation) {
        Object delay = delay(m1330toDelayMillisLRDsOJo(d), continuation);
    ...
    public static final long m1330toDelayMillisLRDsOJo(double d) {
        if (Duration.m1272compareToLRDsOJo(d, Duration.INSTANCE.m1318getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1309toLongMillisecondsimpl(d), 1L);
        }
        return 0L;
    }
