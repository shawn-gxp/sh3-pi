...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m15constructorimpl = Result.m15constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m15constructorimpl = Result.m15constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m21isFailureimpl(m15constructorimpl) ? null : m15constructorimpl);
