...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    final class LockCont extends LockWaiter {
        ...
        public Object tryResumeLockWaiter() {
            return this.cont.tryResume(Unit.INSTANCE, null, new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.sync.MutexImpl$LockCont$tryResumeLockWaiter$1
                {
                    super(1);
                }
                ...
                public final void invoke2(Throwable th) {
                    MutexImpl.this.unlock(MutexImpl.LockCont.this.owner);
                }
            });
        }
    ...
    private final class LockSelect<R> extends LockWaiter {
        ...
        public void completeResumeLockWaiter(Object token) {
            ...
            CancellableKt.startCoroutineCancellable(this.block, MutexImpl.this, this.select.getCompletion(), new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.sync.MutexImpl$LockSelect$completeResumeLockWaiter$2
                {
                    super(1);
                }
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Throwable th) {
                    MutexImpl.this.unlock(MutexImpl.LockSelect.this.owner);
                }
            });
        }
    ...
    final /* synthetic */ Object lockSuspend(final Object obj, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                LockFreeLinkedListNode.CondAddOp condAddOp = new LockFreeLinkedListNode.CondAddOp(lockCont2) { // from class: kotlinx.coroutines.sync.MutexImpl$lockSuspend$$inlined$suspendCancellableCoroutineReusable$lambda$1
                    @Override // kotlinx.coroutines.internal.AtomicOp
                    public Object prepare(LockFreeLinkedListNode affected) {
                        if (this._state == obj2) {
                            return null;
