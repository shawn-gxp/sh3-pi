...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m18exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (m18exceptionOrNullimpl != null) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (cancellableContinuation2 instanceof CoroutineStackFrame)) {
                m18exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m18exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
            }
            obj = new CompletedExceptionally(m18exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
