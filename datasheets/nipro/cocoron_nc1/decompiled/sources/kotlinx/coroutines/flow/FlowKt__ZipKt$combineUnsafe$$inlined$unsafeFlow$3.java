...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3<R> implements Flow<R> {
    final /* synthetic */ Flow[] $flows$inlined;
    final /* synthetic */ Function2 $transform$inlined;

    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3(Flow[] flowArr, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, nullArrayFactory$FlowKt__ZipKt, new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3$lambda$1(null, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3.1
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3.this.collect(null, this);
            }
        };
        InlineMarker.mark(5);
        Flow[] flowArr = this.$flows$inlined;
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, nullArrayFactory$FlowKt__ZipKt, flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$3$lambda$1, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
