...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1<T> implements FlowCollector<T> {
    ...
    public Object emit$$forInline(Object obj, Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1.1
            ...
            public final Object invokeSuspend(Object obj2) {
                ...
                return FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1.this.emit(null, this);
            }
        };
        InlineMarker.mark(5);
        return this.this$0.$transform$inlined.invoke(this.$this_unsafeFlow$inlined, obj, continuation);
