...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x00b1 A[Catch: all -> 0x0078, TryCatch #1 {all -> 0x0078, blocks: (B:13:0x0041, B:14:0x00ad, B:16:0x00b1, B:18:0x00b6, B:20:0x00db, B:22:0x00e1, B:26:0x00bd, B:29:0x00c4, B:39:0x0061, B:41:0x0074, B:42:0x009c), top: B:7:0x0025 }] */
    /* JADX WARN: Removed duplicated region for block: B:18:0x00b6 A[Catch: all -> 0x0078, TryCatch #1 {all -> 0x0078, blocks: (B:13:0x0041, B:14:0x00ad, B:16:0x00b1, B:18:0x00b6, B:20:0x00db, B:22:0x00e1, B:26:0x00bd, B:29:0x00c4, B:39:0x0061, B:41:0x0074, B:42:0x009c), top: B:7:0x0025 }] */
    /* JADX WARN: Removed duplicated region for block: B:22:0x00e1 A[Catch: all -> 0x0078, TRY_LEAVE, TryCatch #1 {all -> 0x0078, blocks: (B:13:0x0041, B:14:0x00ad, B:16:0x00b1, B:18:0x00b6, B:20:0x00db, B:22:0x00e1, B:26:0x00bd, B:29:0x00c4, B:39:0x0061, B:41:0x0074, B:42:0x009c), top: B:7:0x0025 }] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:21:0x00df -> B:14:0x00ad). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:23:0x00f3 -> B:14:0x00ad). Please report as a decompilation issue!!! */
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        try {
            if (continuation instanceof StateFlowImpl$collect$1) {
                ...
                if ((stateFlowImpl$collect$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        obj = stateFlowImpl$collect$1.L$5;
                        ...
                        stateFlowImpl$collect$1.L$5 = obj5;
                        ...
                        if (obj != null) {
                            boolean z = !Intrinsics.areEqual(obj, obj52);
                            obj2 = obj52;
                        }
                        t = obj52 == NullSurrogateKt.NULL ? null : obj52;
                        stateFlowImpl$collect$1.L$0 = stateFlowImpl;
                        stateFlowImpl$collect$1.L$1 = flowCollector2;
                        stateFlowImpl$collect$1.L$2 = stateFlowSlot;
                        stateFlowImpl$collect$1.L$3 = job;
                        stateFlowImpl$collect$1.L$4 = obj;
                        stateFlowImpl$collect$1.L$5 = obj52;
                        stateFlowImpl$collect$1.label = 2;
                        if (flowCollector2.emit(t, stateFlowImpl$collect$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        ...
                        if (!stateFlowSlot.takePending()) {
                            ...
                            stateFlowImpl$collect$1.L$3 = job;
                            stateFlowImpl$collect$1.L$4 = obj;
                            stateFlowImpl$collect$1.L$5 = obj2;
                        ...
                        stateFlowImpl$collect$1.L$3 = job;
                        stateFlowImpl$collect$1.L$4 = obj;
                        stateFlowImpl$collect$1.L$5 = obj522;
                        stateFlowImpl$collect$1.label = 2;
                        if (flowCollector2.emit(t, stateFlowImpl$collect$1) == coroutine_suspended) {
                        }
                    } else {
                    ...
                    stateFlowImpl$collect$1.L$3 = job;
                    stateFlowImpl$collect$1.L$4 = obj;
                    stateFlowImpl$collect$1.L$5 = obj5222;
                    stateFlowImpl$collect$1.label = 2;
                    if (flowCollector2.emit(t, stateFlowImpl$collect$1) == coroutine_suspended) {
                    }
                }
            ...
            stateFlowImpl$collect$1.L$3 = job;
            stateFlowImpl$collect$1.L$4 = obj;
            stateFlowImpl$collect$1.L$5 = obj52222;
            stateFlowImpl$collect$1.label = 2;
            if (flowCollector2.emit(t, stateFlowImpl$collect$1) == coroutine_suspended) {
            }
        } catch (Throwable th2) {
