...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(flowCollector, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 flowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$lambda$1(flowCollector, this);
        InlineMarker.mark(0);
