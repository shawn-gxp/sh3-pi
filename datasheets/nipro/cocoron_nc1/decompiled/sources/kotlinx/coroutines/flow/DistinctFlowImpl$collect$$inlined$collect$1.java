        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    T t = (T) this.this$0.keySelector.invoke(obj);
                    if (this.$previousKey$inlined.element == NullSurrogateKt.NULL || !this.this$0.areEquivalent.invoke(this.$previousKey$inlined.element, t).booleanValue()) {
