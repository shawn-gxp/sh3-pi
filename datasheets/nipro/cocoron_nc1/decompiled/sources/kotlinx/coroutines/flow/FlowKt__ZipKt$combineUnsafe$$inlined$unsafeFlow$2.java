...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2(Flow[] flowArr, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, nullArrayFactory$FlowKt__ZipKt, new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1(null, this), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, nullArrayFactory$FlowKt__ZipKt, flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
