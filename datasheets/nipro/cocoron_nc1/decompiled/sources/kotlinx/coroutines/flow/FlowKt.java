...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1354catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1359catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1355debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1357debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m1356sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1358sample8GFy2Ro(flow, d);
    }
