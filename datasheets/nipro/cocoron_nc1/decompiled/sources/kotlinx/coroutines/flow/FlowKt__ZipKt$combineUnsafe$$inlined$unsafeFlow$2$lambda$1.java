...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    int label;
    ...
    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1(Continuation continuation, FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2 flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2) {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1 flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1 = new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1(continuation, this.this$0);
    ...
    public final Object invoke(Object obj, Object obj2, Continuation<? super Unit> continuation) {
        return ((FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$2$lambda$1) create((FlowCollector) obj, (Object[]) obj2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
