...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public BroadcastChannel<T> broadcastImpl(CoroutineScope scope, CoroutineStart start) {
        ...
        return BroadcastKt.broadcast$default(scope, this.context, produceCapacity, start, null, getCollectToFun$kotlinx_coroutines_core(), 8, null);
    }

    public ReceiveChannel<T> produceImpl(CoroutineScope scope) {
        return ProduceKt.produce$default(scope, this.context, getProduceCapacity(), this.onBufferOverflow, CoroutineStart.ATOMIC, null, getCollectToFun$kotlinx_coroutines_core(), 16, null);
    }
