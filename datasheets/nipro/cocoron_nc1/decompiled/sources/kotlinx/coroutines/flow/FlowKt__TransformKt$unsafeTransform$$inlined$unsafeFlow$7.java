...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7$lambda$1(flowCollector, this), continuation);
