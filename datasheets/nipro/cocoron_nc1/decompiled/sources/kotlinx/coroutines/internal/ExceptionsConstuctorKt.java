...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m15constructorimpl = Result.m15constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m15constructorimpl = Result.m15constructorimpl(ResultKt.createFailure(th));
            }
            return (E) (Result.m21isFailureimpl(m15constructorimpl) ? null : m15constructorimpl);
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    if (newInstance != null) {
                        ...
                        th3.initCause(th);
                        m15constructorimpl = Result.m15constructorimpl(th3);
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (newInstance != null) {
                            m15constructorimpl = Result.m15constructorimpl((Throwable) newInstance);
                            if (Result.m21isFailureimpl(m15constructorimpl)) {
                                m15constructorimpl = null;
                            }
                            return (Throwable) m15constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    m15constructorimpl = Result.m15constructorimpl((Throwable) Function1.this.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m15constructorimpl = Result.m15constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m15constructorimpl = Result.m15constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m15constructorimpl = Result.m15constructorimpl(ResultKt.createFailure(th));
        }
