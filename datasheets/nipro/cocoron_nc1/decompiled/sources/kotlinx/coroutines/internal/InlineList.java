...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1362boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Object m1363constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m1368hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public static String m1370toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ")";
    }

    public boolean equals(Object other) {
        return m1365equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m1368hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1370toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1364constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1363constructorimpl(obj);
    }

    /* renamed from: plus-UZ7vuAc, reason: not valid java name */
    public static final Object m1369plusUZ7vuAc(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1363constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1363constructorimpl(arrayList);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1367forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
