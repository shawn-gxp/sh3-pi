    ...
    */
    ...
    public final boolean offer(E element) {
        ...
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(element, closedForSend));
        }
        if (offerInternal instanceof Closed) {
            throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(element, (Closed) offerInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m15constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m15constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                ...
                m1364constructorimpl$default = InlineList.m1369plusUZ7vuAc(m1364constructorimpl$default, receive);
            }
        }
        if (m1364constructorimpl$default != null) {
            if (!(m1364constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1364constructorimpl$default).resumeReceiveClosed(closed);
            } else {
