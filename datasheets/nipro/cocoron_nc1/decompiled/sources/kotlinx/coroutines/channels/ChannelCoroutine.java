...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    static /* synthetic */ Object m1340receiveOrClosedZYPwvRU$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.mo1339receiveOrClosedZYPwvRU(continuation);
    }
    ...
    public Object mo1339receiveOrClosedZYPwvRU(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m1340receiveOrClosedZYPwvRU$suspendImpl(this, continuation);
    }
    ...
    public final void cancel(CancellationException cause) {
        if (cause == null) {
            ChannelCoroutine<E> channelCoroutine = this;
            cause = new JobCancellationException(channelCoroutine.cancellationExceptionMessage(), (Throwable) null, channelCoroutine);
        }
