...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m1341boximpl(Object obj) {
        return new ValueOrClosed(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Object m1342constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1343equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).getHolder());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1344equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m1348hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object other) {
        return m1343equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m1348hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1350toStringimpl(this.holder);
    }
    ...
    public static final boolean m1349isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getValue-impl, reason: not valid java name */
    public static final T m1346getValueimpl(Object obj) {
    ...
    public static final T m1347getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m1345getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m1350toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object m1353valueZYPwvRU$kotlinx_coroutines_core(E value) {
            return ValueOrClosed.m1342constructorimpl(value);
        }

        /* renamed from: closed-ZYPwvRU$kotlinx_coroutines_core, reason: not valid java name */
        public final <E> Object m1352closedZYPwvRU$kotlinx_coroutines_core(Throwable cause) {
            return ValueOrClosed.m1342constructorimpl(new Closed(cause));
        }
    }
}
