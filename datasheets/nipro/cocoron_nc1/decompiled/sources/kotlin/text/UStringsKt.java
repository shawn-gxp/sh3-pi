...
public final class UStringsKt {
    ...
    public static final String m1263toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1265toStringolVBNx4(short s, int i) {
    ...
    public static final String m1264toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1262toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m101constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m27boximpl(UByte.m33constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m101constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m101constructorimpl = UInt.m101constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m330uintDivideJ1ME1BU(-1, m101constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m101constructorimpl2 = UInt.m101constructorimpl(i2 * m101constructorimpl);
            int m101constructorimpl3 = UInt.m101constructorimpl(UInt.m101constructorimpl(digitOf) + m101constructorimpl2);
            if (UnsignedKt.uintCompare(m101constructorimpl3, m101constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m101constructorimpl3;
        }
        return UInt.m95boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m171constructorimpl = ULong.m171constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m332ulongDivideeb3DHEI(j, m171constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m171constructorimpl2 = ULong.m171constructorimpl(j2 * m171constructorimpl);
            long m171constructorimpl3 = ULong.m171constructorimpl(ULong.m171constructorimpl(UInt.m101constructorimpl(r15) & 4294967295L) + m171constructorimpl2);
            if (UnsignedKt.ulongCompare(m171constructorimpl3, m171constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m171constructorimpl3;
            j = -1;
        }
        return ULong.m165boximpl(j2);
    }
}
