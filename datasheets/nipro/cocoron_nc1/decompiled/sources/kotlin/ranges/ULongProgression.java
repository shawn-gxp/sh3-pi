...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1181getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m171constructorimpl = ((int) ULong.m171constructorimpl(j ^ ULong.m171constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m171constructorimpl2 = (m171constructorimpl + ((int) ULong.m171constructorimpl(j2 ^ ULong.m171constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m171constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m208toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m208toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1204fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
