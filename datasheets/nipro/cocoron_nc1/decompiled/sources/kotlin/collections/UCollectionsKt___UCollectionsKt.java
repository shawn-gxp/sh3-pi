...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] m76constructorimpl = UByteArray.m76constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m87setVurrAj0(m76constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m157setVXSXFK8(m146constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] m216constructorimpl = ULongArray.m216constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m227setk8EXiF4(m216constructorimpl, i, it.next().getData());
            i++;
        }
        return m216constructorimpl;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] m312constructorimpl = UShortArray.m312constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m323set01HTLdE(m312constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final int sumOfUInt(Iterable<UInt> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m101constructorimpl(i + it.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> sum) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.m171constructorimpl(j + it.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m101constructorimpl(i + UInt.m101constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m101constructorimpl(i + UInt.m101constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return i;
    }
}
