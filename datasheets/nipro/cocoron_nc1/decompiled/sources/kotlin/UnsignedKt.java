...
public final class UnsignedKt {
    ...
    public static final int m330uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m101constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }
    ...
    public static final long m332ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m171constructorimpl(0L) : ULong.m171constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m171constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m171constructorimpl(j3 + (ulongCompare(ULong.m171constructorimpl(j - (j3 * j2)), ULong.m171constructorimpl(j2)) < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m333ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m171constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m171constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m171constructorimpl(j3), ULong.m171constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m171constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= d2) {
            return UInt.m101constructorimpl((int) d);
        }
        return UInt.m101constructorimpl(UInt.m101constructorimpl((int) (d - d2)) + UInt.m101constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < LongCompanionObject.MAX_VALUE) {
            return ULong.m171constructorimpl((long) d);
        }
        return ULong.m171constructorimpl(ULong.m171constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
