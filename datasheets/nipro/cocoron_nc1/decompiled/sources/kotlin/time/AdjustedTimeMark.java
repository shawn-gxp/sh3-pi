...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double mo1266elapsedNowUwyO8pc() {
        return Duration.m1296minusLRDsOJo(this.mark.mo1266elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1267plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1297plusLRDsOJo(this.adjustment, duration), null);
    }
}
