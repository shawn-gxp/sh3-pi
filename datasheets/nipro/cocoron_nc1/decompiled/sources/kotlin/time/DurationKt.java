...
public final class DurationKt {
    ...
    private static final double m1320timesmvk6XK0(int i, double d) {
        return Duration.m1300timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1319timeskIfJnKk(double d, double d2) {
        return Duration.m1299timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1273constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
