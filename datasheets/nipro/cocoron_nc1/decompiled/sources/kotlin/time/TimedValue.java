...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1324copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1326copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m1326copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1311toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1327getDurationUwyO8pc() {
        return this.duration;
    }
