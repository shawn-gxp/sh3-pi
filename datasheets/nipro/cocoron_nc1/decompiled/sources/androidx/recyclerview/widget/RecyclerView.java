    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState == 1) {
                ...
                if (scrollByInternal(canScrollHorizontally != 0 ? i2 : 0, canScrollVertically ? i3 : 0, obtain)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
        ...
        */
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                boolean z = (i6 == 0 && i7 == 0) || (i6 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i == i6) || (i7 != 0 && RecyclerView.this.mLayout.canScrollVertically() && i2 == i7);
