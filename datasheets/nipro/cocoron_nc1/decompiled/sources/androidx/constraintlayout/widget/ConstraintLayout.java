...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            boolean z9 = baseline != i3 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
        ...
        if (layoutParams.circleConstraint != -1) {
            ...
            if (layoutParams.baselineToBaseline != -1) {
                ...
                if (constraintWidget11 != null && view2 != null && (view2.getLayoutParams() instanceof LayoutParams)) {
                    ...
                    constraintWidget.getAnchor(ConstraintAnchor.Type.BASELINE).connect(constraintWidget11.getAnchor(ConstraintAnchor.Type.BASELINE), 0, -1, USE_CONSTRAINTS_HELPER);
