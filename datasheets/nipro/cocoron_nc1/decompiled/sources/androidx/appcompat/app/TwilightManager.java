...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - MaxMinRri24hDto.range, location.getLatitude(), location.getLongitude());
        ...
        twilightCalculator.calculateTwilight(MaxMinRri24hDto.range + currentTimeMillis, location.getLatitude(), location.getLongitude());
