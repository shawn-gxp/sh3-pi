...
public class LunarCalendar {
    ...
    public static final int[] lunarToSolar(int i, int i2, int i3, boolean z) {
        ...
        int i7 = i5 + i3;
        int[] iArr2 = LUNAR_INFO;
        int i8 = (iArr2[i4] & 15728640) >> 20;
        if (i8 != 0 && (i2 > i8 || (i2 == i8 && z))) {
            i7 = ((524288 >> (i2 - 1)) & iArr2[i4]) == 0 ? i7 + 29 : i7 + 30;
        }
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        ...
        int i4 = MIN_YEAR;
        int i5 = 0;
        int time = (int) ((new GregorianCalendar(i, i2 - 1, i3).getTime().getTime() - new GregorianCalendar(MIN_YEAR, 0, 31).getTime().getTime()) / MaxMinRri24hDto.range);
        int i6 = 0;
